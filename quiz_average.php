...
<head>
 ...
 <style>
       *{
        ...
        body {
        background-image: url('bg/bg_average.gif');
    ...
    100% {
        opacity: 1;
        text-shadow: 0 0 20px #00ffff, 0 0 0px #00ffff, 0 0 50px #00ffff;
       }
    }
      h1.animated-title {
    ...
    .hero {
            ...
            min-height: 100vh;
            width: 100%;
            background: url(index/bg-dot.png), url(index/bg-dot.png), url(index/bg-tree.png);
            background-position: 10px 10px, bottom 215px right 10px, left 45% bottom -1px;
...
<div class="container">
    <br><h1 class="animated-title">Mind Melter: Challenge Your Wits!</h1></br>
        <marquee behavior="scroll" direction="left" scrollamount="15" scrolldelay="1"><h1>'Average' is comfortable isn't it?</h1></marquee>
        <form method="POST">
    <!-- Question 1 -->
