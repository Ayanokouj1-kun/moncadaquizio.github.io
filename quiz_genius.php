...
<style>
        *{
        ...
        body {
        background-image: url('bg/bg_genius.gif');
    ...
    100% {
        opacity: 1;
        text-shadow: 0 0 20px #e60073, 0 0 0px #e60073, 0 0 50px #e60073;
       }
    }
      h1.animated-title {
...
<div class="container">
    <br><h1 class="animated-title">Mind Melter: Challenge Your Wits!</h1></br>
         <marquee behavior="scroll" direction="left" scrollamount="15" scrolldelay="1"><h1>'Genius' is where magic happens</h1></marquee>
        <form method="POST">
    <!-- Question 1 -->
